...
interface DisclosureProps {
  ...
  setDisclosureAccepted: (accepted: boolean) => void
  branding: {
    owner?: string
  }
}
...
export const Disclosure: React.FC<DisclosureProps> = ({
  ...
  const disclosureText = (String(branding.owner || '').toLowerCase().includes('tradesurf') 
    ? TRADESURF_DISCLOSURE_TEXT 
    : DISCLOSURE_TEXT).trim()

  return (
    <div
      onClick={handleClose}
      className="fixed inset-0 bg-black/60 flex items-center justify-center p-5 z-[1600]"
    >
      <div
        onClick={e => e.stopPropagation()}
        className="w-[920px] max-w-[94vw] max-h-[88vh] overflow-hidden rounded-2xl bg-white border border-gray-200 shadow-[0_20px_60px_rgba(0,0,0,0.35)] flex flex-col"
      >
        <div
          className="px-4 py-[14px] bg-gradient-to-r from-[#0095FF] to-[#10C8A9] text-white flex items-center justify-between"
        >
          <div className="flex flex-col">
            <div className="font-black text-base">Disclosure & Disclaimer</div>
            <div className="text-xs opacity-90">Trading assisted by AI agents not investment advice.</div>
          </div>
          <button
            onClick={handleClose}
            className="border-none bg-white bg-opacity-12 text-black w-[34px] h-[34px] rounded-xl cursor-pointer font-bold opacity-100 disabled:cursor-not-allowed disabled:opacity-60"
            disabled={!disclosureAccepted}
          >
            ×
          </button>
        </div>
        <div className="px-8 py-4 overflow-y-auto bg-white">
          <div className="text-[12.5px] text-slate-900 leading-[1.55]">
            <div className="space-y-4">
              <div>
                <h2 className="font-bold text-sm text-slate-900 mb-2">1. About Our Services</h2>
                <p className="mb-2">Fyntrix is a technology-driven analytics and research support platform that leverages artificial intelligence (AI), data science models, and quantitative frameworks to identify market patterns, research insights, and potential trading or investment opportunities.</p>
                <p>The platform does not provide direct investment advice. All research outputs, signals, or insights generated by the AI system are reviewed and vetted by a SEBI-registered Research Analyst before being made available to users, wherever applicable.</p>
              </div>

              <div className="border-t border-gray-200 pt-4">
                <h2 className="font-bold text-sm text-slate-900 mb-2">2. Nature of AI-Generated Research</h2>
                <p className="mb-2">The insights provided on the Fyntrix platform are generated using algorithmic and AI-based models that analyze historical and real-time market data. These models:</p>
                <ul className="list-disc pl-5 space-y-1">
                  <li>Are probabilistic in nature</li>
                  <li>Are based on historical patterns and assumptions</li>
                  <li>Do not guarantee future performance or outcomes</li>
                </ul>
                <p className="mt-2">AI-generated outputs are intended to assist research and analysis, and should not be construed as definitive predictions or assured trading outcomes.</p>
              </div>

              <div className="border-t border-gray-200 pt-4">
                <h2 className="font-bold text-sm text-slate-900 mb-2">3. Role of the SEBI-Registered Research Analyst</h2>
                <p className="mb-2">Research ideas and trading opportunities published on the platform are vetted, validated, and approved by a Research Analyst registered with the Securities and Exchange Board of India (SEBI), in compliance with the SEBI (Research Analysts) Regulations, 2014.</p>
                <p className="mb-2">The Research Analyst is responsible for:</p>
                <ul className="list-disc pl-5 space-y-1">
                  <li>Ensuring regulatory compliance of published research</li>
                  <li>Applying professional judgment over AI-generated insights</li>
                  <li>Making final determinations on research suitability for publication</li>
                </ul>
                <p className="mt-2 italic text-slate-700">"Registration granted by SEBI, and certification by NISM, do not in any way guarantee performance of the Research Analyst or accuracy of the research provided."</p>
              </div>

              <div className="border-t border-gray-200 pt-4">
                <h2 className="font-bold text-sm text-slate-900 mb-2">4. No Investment Advisory or Portfolio Management Services</h2>
                <p className="mb-2">Fyntrix does not:</p>
                <ul className="list-disc pl-5 space-y-1">
                  <li>Offer personalized investment advice</li>
                  <li>Act as an Investment Adviser (IA)</li>
                  <li>Provide Portfolio Management Services (PMS)</li>
                  <li>Execute trades on behalf of users</li>
                </ul>
                <p className="mt-2">Users are solely responsible for evaluating research outputs and making their own investment or trading decisions based on their financial goals, risk appetite, and investment horizon.</p>
              </div>

              <div className="border-t border-gray-200 pt-4">
                <h2 className="font-bold text-sm text-slate-900 mb-2">5. Risk Disclosure</h2>
                <p className="mb-2">Investments in securities markets are subject to market risks, including loss of capital.</p>
                <p className="mb-2">Past performance of any strategy, model, or research output:</p>
                <ul className="list-disc pl-5 space-y-1">
                  <li>Is not indicative of future results</li>
                  <li>Should not be relied upon as a guarantee of returns</li>
                </ul>
                <p className="mt-2">Users are advised to exercise due caution and consult independent financial or investment advisers, if necessary, before acting on any research or trading ideas.</p>
              </div>

              <div className="border-t border-gray-200 pt-4">
                <h2 className="font-bold text-sm text-slate-900 mb-2">6. Limitation of Liability</h2>
                <p className="mb-2">Fyntrix, its founders, affiliates, employees, and associated Research Analysts shall not be liable for:</p>
                <ul className="list-disc pl-5 space-y-1">
                  <li>Any direct or indirect losses arising from the use of platform insights</li>
                  <li>Trading losses resulting from market volatility</li>
                  <li>Technical disruptions, data inaccuracies, or system delays</li>
                </ul>
                <p className="mt-2">Use of the platform and its research outputs is entirely at the user's own risk.</p>
              </div>

              <div className="border-t border-gray-200 pt-4">
                <h2 className="font-bold text-sm text-slate-900 mb-2">7. Conflict of Interest Disclosure</h2>
                <p>The Research Analyst associated with Fyntrix maintains internal policies and procedures to identify, disclose, and manage potential conflicts of interest, in accordance with SEBI regulations.</p>
                <p className="mt-2">Any material conflicts of interest, if applicable, shall be appropriately disclosed alongside the relevant research output.</p>
              </div>

              <div className="border-t border-gray-200 pt-4">
                <h2 className="font-bold text-sm text-slate-900 mb-2">8. Educational and Informational Purpose</h2>
                <p>Certain content available on the platform may be provided for educational and informational purposes only, including market explanations, technical concepts, and data visualizations. Such content should not be construed as investment recommendations.</p>
              </div>

              <div className="border-t border-gray-200 pt-4">
                <h2 className="font-bold text-sm text-slate-900 mb-2">9. Regulatory Status Disclosure</h2>
                <p className="mb-2">Fyntrix is a technology and analytics platform and is not registered with SEBI as a Research Analyst, Investment Adviser, or Portfolio Manager.</p>
                <p>Research services, where applicable, are provided through and under the supervision of a SEBI-registered Research Analyst.</p>
              </div>

              <div className="border-t border-gray-200 pt-4">
                <h2 className="font-bold text-sm text-slate-900 mb-2">10. User Acknowledgement</h2>
                <p>By accessing or using the Fyntrix platform, users acknowledge that they have read, understood, and agreed to the above disclosures and disclaimers.</p>
              </div>
            </div>
          </div>
        </div>
        <div className="p-[14px] border-t border-gray-200 bg-gray-50 flex justify-end gap-[10px]">
          <button
            onClick={handleAccept}
            className="px-[14px] py-[10px] rounded-xl border border-blue-700 bg-gradient-to-r from-blue-500 to-blue-600 text-white cursor-pointer font-black text-sm opacity-100"
          >
